...
//    });
//
//    it('should have good distribution of  workloads', function(){
//      var router = new chakra.Router();
//      var one = router.register("test1", {id: 1})
//      var two = router.register("test1", {id: 2})
//      console.log(router.select("test1"))
//      console.log(router.select("test1"))
//      console.log(router.select("test1"))
//    });
//
